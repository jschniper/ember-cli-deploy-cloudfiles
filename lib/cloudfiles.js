...
module.exports = CoreObject.extend({
    init: function() {
        if (!this.config) {
            this.error = 'You have to pass a config!';
        }
        else if (!this.config.assets || typeof(this.config.assets.username) === 'undefined' || typeof(this.config.assets.apiKey) === 'undefined' || typeof(this.config.assets.container) === 'undefined') {
            this.error = 'Required config options are missing';
        }
        else {
    ...
    upload: function() {
        ...
        if (this.error) {
            return Promise.reject(new SilentError(this.error));
        }
