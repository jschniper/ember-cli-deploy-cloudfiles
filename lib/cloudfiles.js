...
module.exports = CoreObject.extend({
    init: function() {
        ...
        if (!this.config.assets || typeof(this.config.assets.username) === 'undefined' || typeof(this.config.assets.apiKey) === 'undefined' || typeof(this.config.assets.container) === 'undefined') {
            return Promise.reject(new SilentError('Required config options are missing'));
        }
